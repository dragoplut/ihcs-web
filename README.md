...
# IHCS "Conductor" web application based on Angular Webpack Starter
...
## To build app for device please do next

# Do a prod build of app
```
npm run build:prod
```
source of app will appear in directory "dist"

# Copy "dist" to device folder "flexicontrol/website/static/angularapp/" directory

# Make required changes in "flexicontrol/website/index.lua" file
